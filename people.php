...
<?php include 'header.php'; ?>
    ...
    <section class="people">
        ...
        <div class="person">
            ...
            <div class="person_name">            
                <a href="jay.php"><h1>Jay Winthrop</h1></a>
                <p>Principal</p>
            </div>
        ...
        <div class="person">
            ...
            <div class="person_name">
                <a href="lea.php"><h1>Lea Paine Highet</h1></a>
                <p>Principal</p>
            </div>
        </div>
        <div class="person">
            ...
            <div class="person_name">
                <a href="charlie.php"><h1>Charles Howard</h1></a>
                <p>Principal</p>
            </div>
        </div>
        <div class="person">
        ...
        <div class="person">
            ...
            <div class="person_name">
                <a href="cgcrane.php"><h1>Charles Crane</h1></a>
                <p>Principal</p>
            </div>
        </div>
        <div class="person">
            ...
            <div class="person_name">
                <a href="josh.php"><h1>Josh Huffard</h1></a>
                <p>Principal</p>
            </div>
        </div>
        <div class="person">
            ...
            <div class="person_name">
                <a href="bryce.php"><h1>D. Bryce O'Brien II</h1></a>
                <p>Principal</p>
            </div>
        </div>
        <div class="person">
        ...
        <div class="person">
            ...
            <div class="person_name">
                <a href="bowdy.php"><h1>C. Bowdoin Train</h1></a>
                <p>Principal</p>
            </div>
        </div>
        <div class="person">
            ...
            <div class="person_name">
                <a href="sonny.php"><h1>Sonny Degady</h1></a>
        ...
        <div class="person">
            ...
            <div class="person_name">
                <a href="phil.php"><h1>Phillip Warner</h1></a>
        ...
        <div class="person">
            ...
            <div class="person_name">
                <a href="grant.php"><h1>Grant Winthrop</h1></a>
                <p>Managing Director</p>
            </div>
        </div>
        <div class="person">
            ...
            <div class="person_name">
                <a href="rossana.php"><h1>Rossana Azzara</h1></a>
        ...
        <div class="person">
            ...
            <div class="person_name">
                <a href="koren.php"><h1>Koren Howe</h1></a>
                <p>Client Relations Manager</p>
            </div>
        </div>
        <div class="person">
            ...
            <div class="person_name">
                <a href="olivia.php"><h1>Olivia Le Blan</h1></a>
                <p>Associate</p>
            </div>
        </div>
        <div class="person">
            ...
            <div class="person_name">
                <a href="alex.php"><h1>Alexandra Panetta</h1></a>
