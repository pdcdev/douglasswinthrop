    ...
    <aside class="page_banner_home">
        <div class="overlay_home">
            <div class="inner_banner_home">
                <div class="home-logo">
                    <h1 class="home-logo-name">Douglass Winthrop</h1>
                </div> 
                <div class="home-message"><p>Investment advisors to individuals, families, trusts and endowments.</p>
                </div>
        ...
        <div id="footer">
            <div class="inner_footer">
                <ul>
                    ...
                    <li><a href ="terms.php">Credits   &nbsp;&nbsp;l&nbsp;&nbsp;   Legal</a></li>
